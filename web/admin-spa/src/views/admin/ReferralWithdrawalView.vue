  ...
  <div class="space-y-6">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
            <tr v-for="record in withdrawals" :key="record.id">
              ...
              <td
                class="whitespace-nowrap px-6 py-4 font-mono text-sm text-gray-500 dark:text-gray-300"
              >
                {{ record.accountInfo }}
              </td>
              ...
              <td class="max-w-xs truncate px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                {{ record.note || '-' }}
              </td>
    ...
    <div v-if="approveDialogOpen" class="fixed inset-0 z-10 overflow-y-auto">
      ...
      >
        ...
        >
        <div
          class="inline-block w-full transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all dark:bg-gray-800 sm:my-8 sm:max-w-lg sm:p-6 sm:align-middle"
        >
          <div>
          ...
          <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
            <button
              type="button"
              :disabled="processing"
              class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 dark:bg-green-500 dark:hover:bg-green-600 sm:ml-3 sm:w-auto sm:text-sm"
            ...
            <button
              type="button"
              class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 sm:mt-0 sm:w-auto sm:text-sm"
              @click="closeDialog"
            >
              取消
            </button>
        ...
        >
          ...
          <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
            <button
              ...
              class="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 dark:bg-red-500 dark:hover:bg-red-600 sm:ml-3 sm:w-auto sm:text-sm"
              @click="confirmReject"
            >
              {{ processing ? '处理中…' : '确认拒绝' }}
            </button>
