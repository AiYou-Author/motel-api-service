<template>
  <div class="space-y-6">
            ...
            <div class="ml-4 w-0 flex-1">
              <dl>
                ...
                <dd class="text-2xl font-bold text-gray-900 dark:text-white">
                  ¥{{ referralInfo.balance?.toFixed(2) || 0.0 }}
                </dd>
              </dl>
            </div>
          </div>
    ...
    <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
      <div class="p-6">
        <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">我的推广链接</h3>
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
          新用户通过以上链接注册并购买套餐，您将获得订单金额
          {{ referralInfo.commissionRate * 100 || 0 }}% 的返佣奖励
        </p>
      </div>
    </div>
    ...
    >
      <div class="max-w-2xl p-6">
        <h3 class="mb-6 text-lg font-medium text-gray-900 dark:text-white">申请提现</h3>
          ...
          <div>
            ...
            <div class="relative mt-1 rounded-md shadow-sm">
              ...
              <input
                ...
                class="block w-full rounded-md border-gray-300 pl-7 pr-12 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                placeholder="0.00"
              />
              <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                <span class="text-gray-500 dark:text-gray-400 sm:text-sm">
                  可用: ¥{{ referralInfo.balance?.toFixed(2) || 0.0 }}
                </span>
              </div>
            </div>
          </div>
    ...
    <!-- 提现记录 -->
    <div
      v-if="activeTab === 'withdrawRecords'"
      class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800"
    >
      <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
