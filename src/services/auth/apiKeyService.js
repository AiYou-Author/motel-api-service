...
const serviceRatesService = require('../billing/serviceRatesService')
const requestDetailService = require('../routing/requestDetailService')
const { isClaudeFamilyModel } = require('../../utils/modelHelper')
const { finalizeRequestDetailMeta } = require('../../utils/requestDetailHelper')
const requestBodyRuleService = require('../routing/requestBodyRuleService')
...
class ApiKeyService {
  ...
  async generateApiKey(options = {}) {
    ...
    // 同步添加到费用排序索引
    try {
      const costRankService = require('../billing/costRankService')
    ...
    try {
      const apiKeyIndexService = require('../auth/apiKeyIndexService')
  ...
  async _publishBillingEvent(eventData) {
    try {
      const billingEventPublisher = require('../billing/billingEventPublisher')
