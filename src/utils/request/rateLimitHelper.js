...
const pricingService = require('../../services/billing/pricingService')
const CostCalculator = require('../request/costCalculator')
  ...
  if (
    ...
    if (totalCost > 0 && keyId) {
      try {
        ...
        const serviceRatesService = require('../../services/billing/serviceRatesService')
